        ...
        <g data-testid="card-title" transform="translate(30, 25)">
            <g transform="translate(0, 0)">
                <?php if ($stats['state'] == 'open'): ?>
                    <svg class="icon" x="0" aria-hidden="true" y="10" height="16" style="fill: #3fb950" viewBox="0 0 16 16" width="16" data-view-component="true">
                        <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                        <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
                    </svg>
                <?php elseif ($stats['state'] == 'completed'): ?>
                ...
                <?php else: ?>
                    <svg class="icon" x="0" aria-hidden="true" y="10" height="16" style="fill: #7d8590" viewBox="0 0 16 16" width="16" data-view-component="true">
